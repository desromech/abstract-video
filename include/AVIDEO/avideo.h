...
typedef avideo_error (*avideoContainerReadYUVConvertedFrame_FUN) (avideo_container* container, avideo_int planeIndex, avideo_int pitch, avideo_pointer buffer);
typedef avideo_error (*avideoContainerReadRGBA32ConvertedFrame_FUN) (avideo_container* container, avideo_int pitch, avideo_pointer buffer);
...
AVIDEO_EXPORT avideo_error avideoContainerReadYUVConvertedFrame(avideo_container* container, avideo_int planeIndex, avideo_int pitch, avideo_pointer buffer);
AVIDEO_EXPORT avideo_error avideoContainerReadRGBA32ConvertedFrame(avideo_container* container, avideo_int pitch, avideo_pointer buffer);
...
typedef struct _avideo_icd_dispatch {
	...
	avideoContainerReadYUVConvertedFrame_FUN avideoContainerReadYUVConvertedFrame;
	avideoContainerReadRGBA32ConvertedFrame_FUN avideoContainerReadRGBA32ConvertedFrame;
